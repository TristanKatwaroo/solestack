...
?>
            ...
            <section id="banner">
                <div class="content">
                    <header>
                        <h2>Welcome to the future of reselling.</h2>
                        <p>
                            No shipping fees. No imports or duties fees.<br />
                            Just verified local vendors.
                        </p>
                    </header>
                    <span class="image"><img src="images/profile02.png" alt="" /></span>
                </div>
            ...
            <section id="one" class="spotlight style1 bottom">
                <span class="image fit main"><img src="images/banner02.png" alt="" /></span>
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-4 col-12-medium">
                                <header>
                                    <h2>What is Solestack?</h2>
                                    <p>We connect you to a network of local buyers and sellers with ease.</p>
                                </header>
                            </div>
                            <div class="col-4 col-12-medium">
                                <p>
                                    For too long have you been paying additional fees to sell your
                                    hyped products online. With Solestack, you can source local clients
                                    and vendors. You can purchase a vendor subscription after you complete
                                    a verification process to ensure safety and authenticity.
                                </p>
                            </div>
                            <div class="col-4 col-12-medium">
                                <p>
                                    Our goal is to make it so you never have to pay a single cent on product
                                    transactions again.
                                </p>
                            </div>
                        </div>
            ...
            <section id="two" class="spotlight style2 right">
                ...
                <div class="content">
                    <header>
                        ...
                        <p>Get your vendor verification status for free.</p>
                    </header>
                    <p>For every sign up using your referral code, get an additional free month.</p>
                    <ul class="actions">
